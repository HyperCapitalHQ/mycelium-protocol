# 从平台垄断到协作创新/From Monopoly to Cooperation
我们研究信息技术从单机到网络到移动互联网的技术发展，会发现伴随科技的革新，会产生不同的经济模型和模式。也就是新技术+新经济=新时代。
互联网平台经济（如Amazon、Meta、X、Alibaba、Meituan、Yuewen Group等）的兴起展示了技术和经济社会因素如何催生新的经济模式。这些平台利用移动互联网、互联网技术发展和社会需求潮流，为个人和企业创造了新的机会。以下分析美团等平台兴起的关键因素，并提出一个假想的协作创新的去中心平台“好团”，探讨以社会福祉为导向的协作平台替代传统的垄断为目的的互联网平台经济模式。
